...
# Prompt the user for the number of rehearsals and the duration of each rehearsal
num_rehearsals = int(input("Please enter the number of rehearsals (eg. 5): "))  # User input for number of rehearsals
rehearsal_duration = int(input("Please enter the duration of each rehearsal in minutes (Eg. 120): "))  # User input for rehearsal duration

total_rehearsal_minutes = num_rehearsals * rehearsal_duration  # Total minutes available for rehearsals
...
output_file = 'rehearsal_data.xlsx'
